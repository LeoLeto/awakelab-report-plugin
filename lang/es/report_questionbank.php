...
$string['selectasfinalexam'] = 'Seleccionar como evaluación final';
$string['unitname'] = 'Nombre de la Unidad';
$string['questionname'] = 'Nombre de la Pregunta';
$string['correctanswer'] = 'Respuesta Correcta';
$string['datasource'] = 'Fuente de datos';
$string['questionbankmode'] = 'Banco de preguntas';
$string['quizmode'] = 'Cuestionarios';
$string['selectquizzes'] = 'Seleccionar cuestionarios';
$string['moveup'] = 'Subir';
$string['movedown'] = 'Bajar';
$string['noquizselected'] = 'No se han seleccionado cuestionarios.';
$string['noquizzes'] = 'No se encontraron cuestionarios en este curso.';
$string['selectallquizzes'] = 'Seleccionar todos los cuestionarios';
